...
<body>
          ...
          <td align="center" style="padding: 0;">
            <table style="width: 100%; max-width: 600px; border: none; border-spacing: 0; color: #000;">
              <tbody>
                ...
                <tr>
                  <td align="center"><h1 style="text-align: center;">Daniel Antonio Sánchez Romero</h1></td>
                </tr>
                <tr>
                  <td align="center">
  ...
  {{-- <div class="container">
    ...
    <h3>VIP</h3>
    <h6 style="margin-top: 0px; text-align: center;">Bienvenido al grupo selecto de Nikkei, has recibido <strong style="font-weight: 500;">20%</strong> de descuento en tus compras, recuerda presentar este QR al momento de tu compra</h6>

    <img src="{{asset('/qrcode/5_Daniel-Antonio-Sánchez-Romero.png')}}" style="width: 80%; max-width: 300px;" alt="">

    <h1 style="text-align: center;">Daniel Antonio Sánchez Romero</h1>
    <div style="background-color: #b8242e; border-radius: 10px 10px 0px 0px; padding: 10px 40px;">
      <div style="margin: 0 auto; text-align: center;">
